...
// To-Do: Specify your screens folder to generate the screen in.
const SCREENS_FOLDER = "admin_app/lib/src/screens";
...
void main() async {
  final screensDir = "$currentScriptDir/../$SCREENS_FOLDER";
